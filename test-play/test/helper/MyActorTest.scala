...
import Messages.{MyMessageRequestTwitt, MyMessage, MyMessageResponse}
 ...
 */
class MyActorTest extends Specification with NoTimeConversions with org.specs2.mock.Mockito {
